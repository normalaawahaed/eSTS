<%@ Page Title="" Language="C#" MasterPageFile="~/SiteInspinia.Master" AutoEventWireup="true" CodeBehind="OpAppA.aspx.cs" Inherits="eSTS.Operation.OpAppA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-lg-10">
                                ...
                                <dl class="row mb-0">
                                    <div class="col-sm-4 text-sm-right">
                                        <dt>Agent Code : <font color="red">*</font></dt>
                                    </div>
                                    <div class="col-sm-4 text-sm-left">
                                        <dd class="mb-1">
    ...
    e.processOnServer = true;  
                                ...
                                <asp:EntityDataSource ID="dsFSU" runat="server" ConnectionString="name=eSTS_StagEntities" DefaultContainerName="eSTS_StagEntities" EnableFlattening="False" EntitySetName="v_OpLicCompanyVessel" OnSelecting="dsFSU_Selecting"  Select="it.[LicCompanyVesselID], it.[LicCompanyID], it.[ShipLicenseNo], it.[CompID], it.[ShipID], it.[OffNo], it.[ShipName], it.[PortReg], it.[CallSign], it.[IMONo], it.[YearReg], it.[YearBuilt], it.[GRT], it.[NRT], it.[LatDegree], it.[LatMin], it.[LatSec], it.[Latitude], it.[Longitude], it.[LongMin], it.[LongDegree], it.[LongSec],it.[DtLicExp]" EntityTypeFilter="">
		...
		ShowShipInfoForm('e');
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 text-sm-right">Supritendant Name <font color="red">*</font></label>
                            <div class="col-lg-4">
                                <dx:BootstrapTextBox ID="txtSupName" ClientInstanceName="txtSupName" runat="server" MaxLength="50">
                                </dx:BootstrapTextBox>
                            </div>
                            <label class="col-sm-1 text-sm-right">Tel No. <font color="red">*</font></label>
                            <div class="col-lg-3">
                         ...
                         <div class="form-group row" runat="server">
                            <label class="col-sm-2 text-sm-right">FSU Call Sign: <font color="red">*</font></label>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        <h3 class="box-title"></h3>
                        <h5><i class="fa fa-ship"></i> Vessel Supplier</h5>
                        <div class="ibox-tools">
                            <a class="collapse-link">
                                <i class="fa fa-chevron-up"></i>
                            </a>
                    ...
                    <div class="ibox-content">
                        <div class="form-group row">
                            <label class="col-sm-2 text-sm-right">Vessel Supplier IMO No <font color="red">*</font></label>
                            <div class="col-sm-4">
	...
	pcSearchShip.PerformCallback();
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 text-sm-right">Vessel Supplier Name  <font color="red">*</font></label>
                            <div class="col-sm-4">
                            ...
                            <label class="col-sm-2 text-sm-right">
                                Vessel Supplier Flag <font color="red">*</font>
                            </label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-sm-2 text-sm-right">Vessel Supplier GRT  <font color="red">*</font></label>
                            <div class="col-sm-4">
                                <dx:BootstrapTextBox ID="txtGRT" runat="server" ClientInstanceName="txtGRT">
                                    <MaskSettings Mask="&lt;0..99999g&gt;.&lt;00..99&gt;" />
                                </dx:BootstrapTextBox>
                            </div>
                            <label class="col-sm-2 text-sm-right">Vessel Supplier NRT <font color="red">*</font></label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 text-sm-right">Vessel Supplier LOA <font color="red">*</font></label>
                            <div class="col-sm-4">
                           ...
                           <div class="form-group row">
                            <label class="col-sm-2 text-sm-right">Vessel Supplier Call Sign <font color="red">*</font></label>
                            <div class="col-sm-4">
    ...
    <div id="divApprover" runat="server">
        ...
        <div class="col-sm-4 col-sm-offset-1">
              ...
              <dx:BootstrapButton ID="btnReject" runat="server" Text="Reject" EnableTheming="True" OnClick="btnReject_Click" ValidationGroup="btnReject">
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Termination of the license or<br />
                                Blacklisted and<br />
                            ...
                            <p>Penarikan balik lesen aktiviti pelabuhan; dan<br />
