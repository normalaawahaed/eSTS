...
{
    public partial class HistoryActivityA : System.Web.UI.Page
    {
        ...
        protected void lilCM_Init(object sender, EventArgs e)
        {
            ...
            contentUrl = string.Format("UploadCMBL.aspx?mode=v&m=a&appr=0&adm=0&sno={0}", DataBinder.Eval(container.DataItem, "OperationAppID"));
