...
namespace eSTS.Operation {
    ...
    public class rptLampiran1 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "eSTS.Operation.rptLampiran1.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptLampiran1 : Component, ICachedReport {
        
        public CachedrptLampiran1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptLampiran1 rpt = new rptLampiran1();
            rpt.Site = this.Site;
            return rpt;
        }
