<%@ Page Title="" Language="C#" MasterPageFile="~/SiteInspinia.Master" AutoEventWireup="true" CodeBehind="OperationList.aspx.cs" Inherits="eSTS.Operation.OperationList" %>
                       ...
                       <asp:EntityDataSource ID="dsComplete" runat="server" ConnectionString="name=eSTS_StagEntities" DefaultContainerName="eSTS_StagEntities" EnableFlattening="False" EntitySetName="v_OperationApp" OnSelecting="dsComplete_Selecting" OrderBy="it.[EstOperationTime] desc" Select="it.[OperationAppID], it.[SupplyMethodID], it.[CaseNum], it.[DeliveryLocation], it.[VSLatDegree], it.[VSLatMin], it.[VSLongDegree], it.[VSLongMin], it.[VRLatDegree], it.[VRLatMin], it.[VRLongDegree], it.[VRLongMin], it.[VSIMONo], it.[VSName], it.[VSFlag], it.[VSPortReg], it.[VSLOA], it.[VSGRT], it.[VSNRT], it.[VRLOA], it.[VRGRT], it.[VRNRT], it.[VRMMSINo], it.[UOMCode], it.[EstOilMT], it.[EstOperationDateTime], it.[EstOperationTime], it.[OilTypeDesc], it.[ActionStatus], it.[VRIMONo], it.[VRName], it.[VRFlag], it.[VRPortReg], it.[CompanyName], it.[IsPayment], it.[PermitDocLink], it.[NPDocLink], it.[Lampiran1DocLink], it.[IsSubmitCM], it.[PaymentDate], it.[PaymentTime], it.[PaymentAmount], it.[ReceiptNo], it.[PaymentRefID], it.[LabelColor], it.[FlowActionStatusID], it.[MedhodName], it.[MethodCode], it.[IsSubmitBL],it.[VSLatitude],it.[VSLongitude],it.[VRLatitude],it.[VRLongitude],it.[SOCompanyName],it.[ValidPermit],it.[IsAmend],it.[IsAmendApprove]" >
                        ...
                        <dx:BootstrapGridView ID="gridComplete" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridComplete" DataSourceID="dsComplete" KeyFieldName="OperationAppID" EnableTheming="False" OnHtmlDataCellPrepared="gridComplete_HtmlDataCellPrepared">
                            ...
                            <Columns>
                                ...
                                <dx:BootstrapGridViewTextColumn FieldName="MedhodName" Caption="STS Method" VisibleIndex="4" >
                                </dx:BootstrapGridViewTextColumn>
                                <dx:BootstrapGridViewTextColumn FieldName="VSName"  Caption="Vessel FSU"  VisibleIndex="5" ReadOnly="True" >
                                </dx:BootstrapGridViewTextColumn>
                                 <dx:BootstrapGridViewTextColumn FieldName="VRName"  Caption="Vessel Supplier / Receiver"  VisibleIndex="6" ReadOnly="True" >
                                </dx:BootstrapGridViewTextColumn>
                                <dx:BootstrapGridViewTextColumn FieldName="UOMCode" Caption="Product Supply" ReadOnly="True" VisibleIndex="7">
                                </dx:BootstrapGridViewTextColumn>
                                <dx:BootstrapGridViewTextColumn FieldName="ActionStatus" Caption="Status" VisibleIndex="8" ReadOnly="True">
                                </dx:BootstrapGridViewTextColumn>
                            </Columns>
