<%@ Page Title="" Language="C#" MasterPageFile="~/SiteInspinia.Master" AutoEventWireup="true" CodeBehind="OperationListPrint.aspx.cs" Inherits="eSTS.Operation.OperationListPrint" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <asp:HiddenField runat="server" ID="hfApplicationID" ClientIDMode="Static" />
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Operation Date From</label>
                <div class="col-sm-3">
            ...
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">FSU</label>
                <div class="col-sm-3">
                    <dx:BootstrapComboBox ID="cbFSU" runat="server">
                    </dx:BootstrapComboBox>
                </div>
                <div class="col-sm-1" style="padding: 0">
                    <dx:BootstrapButton ID="btnSearch" CssClasses-Icon="fa fa-search" runat="server" AutoPostBack="False" Text="Search" OnClick="btnSearch_Click">
	...
	gridComplete.Refresh();
            ...
            <%--<div class="form-group row">
                <label class="col-sm-2 col-form-label">Operation Method</label>
                <div class="col-sm-3">
                    <dx:BootstrapComboBox ID="cbMethod" runat="server" >
                        <Items>
                            <dx:BootstrapListEditItem Text="All" Value="0" Selected="true">
                            </dx:BootstrapListEditItem>
                            <dx:BootstrapListEditItem Text="Supply Vessel to FSU" Value="1">
                            </dx:BootstrapListEditItem>
                            <dx:BootstrapListEditItem Text="FSU to Vessel Receiver" Value="2">
                            </dx:BootstrapListEditItem>
                        </Items>
                    </dx:BootstrapComboBox>
                </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <%--<i class="fa fa-warning"></i>--%> STS Operation List
                </div>
                <div class="panel-body">
                    <div class="col-lg-12">
                       ...
                       <asp:EntityDataSource ID="dsComplete" runat="server" ConnectionString="name=eSTS_StagEntities" DefaultContainerName="eSTS_StagEntities" EnableFlattening="False" EntitySetName="v_OperationApp" OrderBy="it.[EstOperationTime] desc" Select="it.[OperationAppID], it.[SupplyMethodID], it.[CaseNum], it.[DeliveryLocation], it.[VSLatDegree], it.[VSLatMin], it.[VSLongDegree], it.[VSLongMin], it.[VRLatDegree], it.[VRLatMin], it.[VRLongDegree], it.[VRLongMin], it.[VSIMONo], it.[VSName], it.[VSFlag], it.[VSPortReg], it.[VSLOA], it.[VSGRT], it.[VSNRT], it.[VRLOA], it.[VRGRT], it.[VRNRT], it.[VRMMSINo], it.[UOMCode], it.[EstOilMT], it.[EstOperationDateTime], it.[EstOperationTime], it.[OilTypeDesc], it.[ActionStatus], it.[VRIMONo], it.[VRName], it.[VRFlag], it.[VRPortReg], it.[CompanyName], it.[IsPayment], it.[PermitDocLink], it.[NPDocLink], it.[Lampiran1DocLink], it.[IsSubmitCM], it.[PaymentDate], it.[PaymentTime], it.[PaymentAmount], it.[ReceiptNo], it.[PaymentRefID], it.[LabelColor], it.[FlowActionStatusID], it.[MedhodName], it.[MethodCode], it.[IsSubmitBL],it.[VSLatitude],it.[VSLongitude],it.[VRLatitude],it.[VRLongitude],it.[SOCompanyName],it.[ValidPermit],it.[IsAmend],it.[IsAmendApprove]" >
                        </asp:EntityDataSource>
                        <dx:BootstrapGridView ID="gridComplete" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridComplete"  KeyFieldName="OperationAppID" EnableTheming="False" >
                            ...
                            <Columns>
                                ...
                                <dx:BootstrapGridViewTextColumn FieldName="AgentName" VisibleIndex="4" Caption="Agent Name">
                                </dx:BootstrapGridViewTextColumn>
                                 <dx:BootstrapGridViewTextColumn FieldName="Operator" VisibleIndex="5" Caption="Operator">
                                </dx:BootstrapGridViewTextColumn>
                                <dx:BootstrapGridViewTextColumn FieldName="MethodName" Caption="STS Method" VisibleIndex="6" >
                                </dx:BootstrapGridViewTextColumn>
                                <dx:BootstrapGridViewTextColumn FieldName="FSU"  Caption="Vessel FSU"  VisibleIndex="7" ReadOnly="True" >
                                </dx:BootstrapGridViewTextColumn>
                                 <dx:BootstrapGridViewTextColumn FieldName="Vessel"  Caption="Vessel Supplier / Receiver"  VisibleIndex="8" ReadOnly="True" >
                                </dx:BootstrapGridViewTextColumn>
                                <dx:BootstrapGridViewTextColumn FieldName="EstOperationTime" Caption="Est. Operation Date/Time" ReadOnly="True" VisibleIndex="9">
                                    <PropertiesTextEdit DisplayFormatString="dd/MM/yyyy HH:mm">
                                        <MaskSettings Mask="dd/MM/yyyy HH:mm" />
                                    </PropertiesTextEdit>
                                </dx:BootstrapGridViewTextColumn>
                                <dx:BootstrapGridViewTextColumn FieldName="EstOilMT" Caption="Est. Oil MT" ReadOnly="True" VisibleIndex="10">
                                </dx:BootstrapGridViewTextColumn>
                                   <dx:BootstrapGridViewTextColumn FieldName="ActOilMT" Caption="Act. Oil MT" ReadOnly="True" VisibleIndex="11">
                                </dx:BootstrapGridViewTextColumn>
                                <dx:BootstrapGridViewTextColumn FieldName="ActionStatus" Caption="Status" VisibleIndex="12" ReadOnly="True">
                                </dx:BootstrapGridViewTextColumn>
                            </Columns>
