<%@ Page Title="" Language="C#" MasterPageFile="~/SiteInspiniaMethodB.Master" AutoEventWireup="true" CodeBehind="UploadCMBL_B.aspx.cs" Inherits="eSTS.Operation.UploadCMBL_B" %>
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-title">
                        ...
                        <h5><i class="fa fa-clipboard fa-lg"></i> Declaration of Cargo Manifest / Bill of Lading By Vessel</h5>
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div runat="server" class="ibox-title">
                        <h3 class="box-title"></h3>
                        <h5><i class="fa fa-upload"></i> Upload Cargo Manifest</h5>
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-lg-10">
                                <div class="form-group row">
                                    <label class="col-sm-3 text-sm-right">Cargo Manifest No.<font color="red">*</font></label>
                                    <div class="col-sm-5">
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div id="div1" runat="server" class="ibox-title">
                        <h3 class="box-title"></h3>
                        <h5><i class="fa fa-upload"></i> Upload Bill Of Lading</h5>
                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-lg-10">
                                <div class="form-group row">
                                    <label class="col-sm-3 text-sm-right">Bill of Lading No. </label>
                                    <div class="col-sm-5">
